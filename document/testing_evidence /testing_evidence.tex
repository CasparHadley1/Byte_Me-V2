...
\textbf{What was done:} 
\begin{itemize}
    \item Performed a live screen recording of the end-to-end user journey.
    \item Demonstrated real-time interaction between Seller and Organisation roles.
    \item Validated UI responsiveness and dynamic badge awards.
\end{itemize}

\noindent \textbf{Justification:}
While automated tests verify the logic, this video serves as proof of a functional User Experience . It captures the system's responsiveness and verifies that all components (Frontend, Backend, and Database) are synchronized in a live production environment.
...
\begin{figure}[H]
    ...
    \includemedia[
      ...
      flashvars={
        source=manual_test.mp4
        &autoPlay=false
      }
    ]{ \includegraphics[width=1\linewidth]{video_poster.png} }{VPlayer.swf}
    \caption{Manual Testing Demonstration: Live Application Walkthrough}
\end{figure}

\noindent \textbf{Note:} To view the embedded video, please open this PDF in \textbf{Adobe Acrobat Reader}. If viewing in a web browser, please use the provided external links for the video evidence. 
\url{https://youtu.be/UPZanjSiRqk}
